...
public class Q2 {
	...
	public static void main(String[] args) {
		Scanner sc=new Scanner(System.in);
			int z=sc.nextInt();      //enter test cases

			int[][] arr=new int[z][3]; //creating int[][] of requied size 
			for (int i = 0; i <z; i++) 
			{ 
			...
			for (int i = 1; i <z; i++)  //using for loop of i=1 because I want to check previous element with present element  
			{
